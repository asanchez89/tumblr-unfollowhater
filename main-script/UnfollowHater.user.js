...
function control(function_name, title, function_description) {
...
function process(){
    ...
    .done(function(data) {
        ...
        var followerList = [];
        get_follower_list(followerList, followerPages, furl_ext, 1);
    })
...
function get_follower_list(followerList, followerPages, furl_ext, page){
    ...
    .done( function(data) {
        ...
        $(element).find('.name').each(function(){
            ...
            followerList[followerList.length] = {name: $(this).text(),
                                                 url: link};
            process_end = (page==followerPages);
            if(process_end){
                set_new_follower_list(followerList);
                set_and_display_lists(followerList);
            }else{
                page++;
                get_follower_list(followerList, followerPages, furl_ext, page);
            }
...
function set_and_display_lists(follower_list){
